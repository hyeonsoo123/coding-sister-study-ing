...
//  - tmdbLang(): TMDB API language 파라미터 (콘텐츠 언어)
//  - 언어 변경 시 localStorage 저장 후 새로고침(콘텐츠+UI 한 번에 반영)
//  ※ config.js 보다 먼저 로드되어야 함 (TMDB.LANG 이 이 값을 사용)
// ============================================================
const I18N = (() => {
    const KEY = 'cs_lang';
    const LANGS = {
    ...
    return { t, tmdbLang, current: () => lang, applyStatic };
})();
